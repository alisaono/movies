...
const MovieCard = ({ movie }: MovieCardProps) => {
  ...
  return (
    <div 
      className={`group relative bg-gray-900 rounded-xl shadow-lg hover:shadow-2xl hover:shadow-blue-500/20 transition-all duration-300 transform hover:-translate-y-2 overflow-hidden border border-gray-800 ${
    ...
    >
      ...
      <div className="p-4 group-hover:opacity-0 transition-opacity duration-300">
        {/* Title */}
        <h3 className="font-bold text-white text-lg leading-tight mb-2 line-clamp-1 group-hover:text-blue-400 transition-colors duration-200">
          {movie.title}
        </h3>
